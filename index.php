...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <nav class="nav-route desktop-nav">
          <ul>
            ...
            <li><a href="./Recipe/Recipe.php">Recipe</a></li>
            <li><a href="./about/About.php">About</a></li>
            <li><a href="#">Contact</a></li>
          </ul>
          <div class="auth-buttons desktop-nav">
            <a href="./login/login.php" class="login-button">Login</a>
            <a href="./signup/signup.php"  class="signup-button">Sign Up</a>
          </div>
        </nav>
      </div>
    </header>
      ...
      <div class="container">
        <div class="content">
          <div class="left">
            ...
            <!-- <button type="button" class="getrecipe-button">
              Get the Recipe
            </button> -->
          </div>
          <div class="right">
    ...
    <center>
      <a href="./Recipe/Recipe.php" style="background-color:orange; padding:10px 20px; border-radius:20px; color:white; text-decoration:none;">Get the Recipe</a>
    </center>
    ...
    <!-- <div class="filter-container">
      ...
      />
      <p></p>
      <a href="../Recipe/Recipe.php" style="background-color:orange; padding:10px 20px; border-radius:20px; color:white; ">Get the Recipe</a>
    </div> -->
